...
export default function ClientPaymentPage(){return <main className="client-payment-page"><header className="client-payment-header"><Link className="wordmark" href="/"><span className="wordmark-icon"><i/><i/><i/></span><span>CRM Solutions</span></Link><span>Secure Client Payment Panel</span><Link href="/contact">Need help?</Link></header><PaymentPanel/></main>;}
